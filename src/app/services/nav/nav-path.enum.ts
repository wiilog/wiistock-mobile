export enum NavPathEnum {
    ...
    ARTICLE_CREATION_SCAN_RFID_TAG = 'article-creation-scan-tag-rfid',
    ARTICLE_CREATION_FORM = 'article-creation-form',
    ...
    TRUCK_ARRIVAL_CARRIER = 'truck-arrival-menu',
    ...
    TRACKING_ROUND_MOVEMENT = 'tracking-round-movement',
